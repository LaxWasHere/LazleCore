	 ...
	 @Override
	    public boolean onCommand(final CommandSender se, Command cmd, String label, String[] args) {
	        if (se instanceof Player) {
	            ...
	            menu.setOption(7, new ItemStack(Material.DIAMOND_SHOVEL, 1), "�a�lEvent", "�6Sends you to the event server.");
	            menu.setOption(8, new ItemStack(Material.IRON_HELMET, 1), "�a�lKitPvP", "�6Sends you to the KitPvP server.");
	            menu.setOption(9, new ItemStack(Material.BOW, 1), "�a�lBowWarfare", "�6Sends you to the BowWarfare server.");
	            menu.open(p);
	            return true;
	        }
	        return false;
